...
import (
	...
	createsvr "crud/gen/grpc/create/server"
	"log"
	"net"
	"net/url"
	"sync"
...
func handleGRPCServer(ctx context.Context, u *url.URL, createEndpoints *create.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		createServer = createsvr.New(createEndpoints, nil)
	}
	...
	createpb.RegisterCreateServer(srv, createServer)
