...
// Blog is the payload type of the create service create method.
type Blog struct {
	// ID of a person
	ID *uint32
	// Name of person
...
// RemovePayload is the payload type of the create service remove method.
type RemovePayload struct {
	// ID of blog to remove
	ID uint32
}

// UpdatePayload is the payload type of the create service update method.
