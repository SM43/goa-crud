...
// MountListHandler configures the mux to serve the "create" service "list"
// endpoint.
...
// the "create" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountRemoveHandler configures the mux to serve the "create" service "remove"
// endpoint.
...
// calls the "create" service "remove" endpoint.
...
// MountUpdateHandler configures the mux to serve the "create" service "update"
// endpoint.
...
// calls the "create" service "update" endpoint.
